  ...
  return (
    <div className="relative w-full min-h-screen flex flex-col items-center px-4 py-8 sm:py-12">
      ...
      <div className="relative w-[240px] h-[240px] sm:w-[282px] sm:h-[282px] mt-[72px] sm:mt-[112px]">
        ...
        {/* 중간 원 - 노란색 */}
        <div
          className={`absolute w-[81.2%] h-[81.2%] left-[9.7%] top-[9.4%] rounded-full bg-[#FFE14F] transition-all duration-1000 delay-150 ${
            isAnimating ? "scale-100 opacity-100" : "scale-90 opacity-0"
          }`}
        />
        ...
        <button
          ...
          className={`absolute w-[62.5%] h-[62.5%] left-[19.1%] top-[18.7%] rounded-full bg-[#FF6E00] flex items-center justify-center transition-all duration-1000 delay-300 hover:scale-105 active:scale-95 ${
            isAnimating ? "scale-100 opacity-100" : "scale-90 opacity-0"
          }`}
        >
          {/* 전화 아이콘 */}
          <svg className="w-[56%] h-auto" viewBox="0 0 85 77" fill="none">
            <path
